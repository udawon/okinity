...
export const tourCategories: TourCategory[] = [
  {
    ...
    icon: '⛵',
    image: '/images/private-cruise/cruise.webp',
    tours: [
      {
        id: '1',
        slug: 'vip-business',
        ...
        image: '/images/private-cruise/business-1.webp',
        images: ['/images/private-cruise/business-1.webp'],
        available: true,
      },
      {
        id: '2',
        ...
        image: '/images/private-cruise/filming-1.webp',
        images: ['/images/private-cruise/filming-1.webp'],
        available: true,
      },
      {
        id: '3',
        ...
        image: '/images/private-cruise/party-1.webp',
        images: ['/images/private-cruise/party-1.webp'],
        available: true,
      },
      {
        id: '4',
        ...
        image: '/images/private-cruise/proposal-1.webp',
        images: ['/images/private-cruise/proposal-1.webp'],
        available: true,
      },
    ],
  },
  {
    ...
    icon: '🎣',
    image: '/images/fishing-tour/fishing.webp',
    tours: [
      {
        id: '5',
        slug: 'fishing-3h',
        ...
        image: '/images/fishing-tour/3hour-tour.webp',
        images: ['/images/fishing-tour/3hour-tour.webp'],
        available: true,
      },
      {
        id: '6',
        ...
        image: '/images/fishing-tour/6hour-tour.webp',
        images: ['/images/fishing-tour/6hour-tour.webp'],
        available: true,
      },
      {
        id: '7',
        ...
        image: '/images/fishing-tour/expert-tour.webp',
        images: ['/images/fishing-tour/expert-tour.webp'],
        available: true,
      },
    ],
  },
  {
    ...
    icon: '🎆',
    image: '/images/firework/fireworks.webp',
    tours: [
      {
        id: '8',
        ...
        image: '/images/firework/april-firework.webp',
        images: ['/images/firework/april-firework.webp'],
        available: true,
      },
      {
        id: '9',
        ...
        image: '/images/firework/oct-firework.webp',
        images: ['/images/firework/oct-firework.webp'],
        available: true,
      },
    ],
  },
  {
    ...
    icon: '🍖',
    image: '/images/BBQ/Concept-bbq.webp',
    tours: [
      {
        id: '10',
        slug: 'bbq-lunch',
        ...
        description: {
          ko: '오키나와의 푸른 바다와 햇살 아래 즐기는 런치 바베큐. 신선한 해산물과 프리미엄 식재료로 낮의 바다를 만끽하세요.',
          ja: '沖縄の青い海と日差しの下で楽しむランチバーベキュー。新鮮な海鮮とプレミアム食材で昼の海を満喫。',
          en: 'Enjoy a lunch BBQ under the Okinawa sun and blue sea. Fresh seafood and premium ingredients for a perfect daytime cruise.',
        },
        priceCharter: 300000,
        ...
        durationLabel: { ko: '약 4시간', ja: '約4時間', en: 'Approx. 4 hours' },
        includes: {
          ko: ['바베큐 세트', '해산물', '고기류', '소프트드링크', '디저트'],
          ja: ['BBQセット', '海鮮', 'お肉', 'ソフトドリンク', 'デザート'],
          en: ['BBQ set', 'Seafood', 'Meat', 'Soft drinks', 'Dessert'],
        },
        image: '/images/BBQ/Concept-bbq.webp',
        images: ['/images/BBQ/Concept-bbq.webp'],
        available: true,
      },
      {
        id: '11',
        ...
        description: {
          ko: '오키나와 선셋과 함께하는 프리미엄 디너 바베큐. 석양이 물드는 바다 위에서 프리미엄 와규와 해산물, 알코올 음료와 함께 특별한 저녁을 즐기세요.',
          ja: '沖縄のサンセットと共に楽しむプレミアムディナーバーベキュー。夕日に染まる海の上で、プレミアム和牛と海鮮、アルコール付きの特別な夜を。',
          en: 'Premium dinner BBQ with an Okinawa sunset. Enjoy premium wagyu, seafood, and drinks on the water as the sun sets.',
        },
        priceCharter: 400000,
        pricePerPerson: 35000,
        minPersons: 4,
        ...
        durationLabel: { ko: '약 5시간', ja: '約5時間', en: 'Approx. 5 hours' },
        includes: {
          ko: ['프리미엄 바베큐 세트', '와규', '해산물', '알코올 음료', '디저트'],
          ja: ['プレミアムBBQセット', '和牛', '海鮮', 'アルコールドリンク', 'デザート'],
          en: ['Premium BBQ set', 'Wagyu beef', 'Seafood', 'Alcoholic drinks', 'Dessert'],
        },
        image: '/images/BBQ/Concept-bbq.webp',
        images: ['/images/BBQ/Concept-bbq.webp'],
        available: true,
